    ...
    public static class InitialDataFactory
    {
        ...
        public static List<Book> Books => new List<Book>()
        {
            new Book
            {
                ...
                PublishDate = new DateTime(1979,01,01),
                EBookLink = "",
            ...
            new Book
            {
                ...
                PublishDate = new DateTime(2012,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                PublishDate = new DateTime(2007,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                PublishDate = new DateTime(1984,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                PublisherId = Publishers.FirstOrDefault(x => x.Name == "Азбука-классика").Id,
                PublishDate = new DateTime(2003,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                PublishDate = new DateTime(1991,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                ISBN = "5-280-00690-4",
                PublisherId = Publishers.FirstOrDefault(x => x.Name == "Художественная литература").Id,
                PublishDate = new DateTime(1989,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                ISBN = "",
                PublisherId = Publishers.FirstOrDefault(x => x.Name == "Художественная литература").Id,
                PublishDate = new DateTime(1960,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
            ...
            new Book
            {
                ...
                ISBN = "",
                PublisherId = Publishers.FirstOrDefault(x => x.Name == "Советский писатель").Id,
                PublishDate = new DateTime(1947,01,01),
                EBookLink = "",
                EBookDownloadCount = 0,
                AddUserId  = SD.UserIdForInitialData,
                AddTime = DateTime.Now,
